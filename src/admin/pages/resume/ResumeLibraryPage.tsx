...
export function ResumeLibraryPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (row: ResumeItem) =>
        row.fileUrl ? (
          <a className="text-[#06B6D4] underline" href={row.fileUrl} target="_blank" rel="noreferrer">
            Preview
          </a>
        ) : (
          '—'
    ...
    },
    {
      ...
      render: (row: ResumeItem) =>
        row.fileUrl ? (
          <a className="text-[#06B6D4] underline" href={row.fileUrl} download target="_blank" rel="noreferrer">
            Download
          </a>
        ) : (
          '—'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded border border-white/10 bg-[#0b132000]/80 p-6 shadow-sm">
          ...
          <div>
            ...
            <div className="mt-2 flex items-center gap-3">
              <input
                ...
                className="block w-full rounded border border-white/10 bg-[#0b132000]/60 px-3 py-2 text-sm text-[#C9D1D9] file:mr-4 file:rounded file:border-0 file:bg-[#06B6D4] file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-[#06B6D4]/90"
              />
              <button
                type="button"
                onClick={handleFileUpload}
                disabled={!selectedFile || uploading}
                className="whitespace-nowrap rounded bg-[#06B6D4] px-4 py-2 text-sm font-semibold text-white hover:bg-[#06B6D4]/90 disabled:opacity-50 disabled:cursor-not-allowed"
              >
