  ...
  if (!message) {
    return (
      <div className="rounded border border-white/10 bg-[#0b132000]/80 p-6 shadow-sm">
        ...
        <Link className="mt-3 inline-block text-sm text-[#06B6D4] underline" to="/mhe-control-center/messages">
          Back
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <Link className="mt-2 inline-block text-sm text-[#06B6D4] underline" to="/mhe-control-center/messages">
          Back to messages
        </Link>
      </div>
      <div className="rounded border border-white/10 bg-[#0b132000]/80 p-6 shadow-sm">
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <select
              className="mt-1 rounded border border-white/10 bg-[#0b132000]/60 px-2 py-1 text-sm text-[#C9D1D9]"
        ...
        <div className="mt-4">
          ...
          <div className="mt-1 rounded border border-white/10 bg-[#0b132000]/60 p-3 text-sm text-[#C9D1D9]">
            {message.message}
          </div>
        </div>
        <button
