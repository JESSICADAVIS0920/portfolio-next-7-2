...
export function AuthCallbackPage() {
  ...
  // Also watch for auth state changes from context
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0b132000] via-[#0b132000] to-[#0b132000]/80 flex items-center justify-center px-4 py-10 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md animate-fade-in">
        {/* Card */}
        <div className="rounded-3xl bg-[#0b132000]/80 backdrop-blur-xl border border-white/10 p-8 shadow-2xl text-center">
          {/* Status Icon */}
          <div className="mb-6">
            {status === 'loading' && (
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-[#06B6D4]/20 border border-[#06B6D4]/30">
          ...
          {status === 'loading' && (
            <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-[#06B6D4] to-[#0891B2] animate-progress" />
            </div>
          )}
          ...
          {status === 'error' && (
            <div className="space-y-3">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-[#06B6D4] to-[#0891B2] text-white font-semibold rounded-xl shadow-lg shadow-[#06B6D4]/30 hover:shadow-xl hover:shadow-[#06B6D4]/40 transition-all duration-300"
              >
                Try Again
              </button>
              <button
