    ...
    if (schema.key === 'contact') {
      ...
      return (
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0b132000]/80 p-6 shadow-sm hover:shadow-md transition-shadow">
            <h2 className="text-xs font-semibold uppercase tracking-wider text-[#06B6D4]">Contact Details</h2>
            <div className="mt-5">
              <EntityForm
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0b132000]/80 p-6 shadow-sm hover:shadow-md transition-shadow">
            <h2 className="text-xs font-semibold uppercase tracking-wider text-[#06B6D4]">Social Links</h2>
            <div className="mt-5">
              <EntityForm
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0b132000]/80 p-6 shadow-sm hover:shadow-md transition-shadow">
            <h2 className="text-xs font-semibold uppercase tracking-wider text-[#06B6D4]">Hire Me CTA</h2>
            <div className="mt-5">
              <EntityForm
                fields={hireMeFields}
                initialValues={values}
      ...
      <div className="flex flex-col gap-3">
        <div className="flex justify-between items-start gap-3">
          <div className="min-w-0 flex-1">
            ...
            {subtitle && <p className="text-sm text-[#06B6D4] truncate">{subtitle}</p>}
          </div>
          {status && (
        ...
        <div className="flex gap-2 pt-3 border-t border-white/10 mt-1">
          {onEdit && (
            <button
              onClick={() => onEdit(row)}
              className="flex-1 inline-flex justify-center items-center gap-1.5 rounded-lg bg-[#06B6D4]/10 border border-[#06B6D4]/30 px-3 py-2 text-xs font-medium text-[#06B6D4] hover:bg-[#06B6D4]/20 transition-colors"
            >
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {!isTechStack && !isReorderList && (
        <div className="rounded-2xl border border-white/10 bg-[#0b132000]/80 p-6 shadow-sm">
          <DataTable
          ...
          <ul role="list" className="space-y-3">
            {rows.map((item, index) => (
              <li
                key={item.id}
                role="listitem"
                className="flex items-center justify-between rounded-xl border border-white/10 bg-[#0b132000]/60 px-5 py-4 hover:bg-white/5 transition-colors"
                draggable
                onDragStart={(event) => {
                  setDragId(item.id);
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#06B6D4]/20 text-sm font-semibold text-[#06B6D4]">
                    {index + 1}
                  </span>
                  <button
                    type="button"
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    className="rounded-lg border border-[#06B6D4]/30 bg-[#06B6D4]/10 px-3 py-1.5 text-xs font-medium text-[#06B6D4] hover:bg-[#06B6D4]/20 transition-colors"
        ...
        <div className="space-y-6">
          ...
          <ul role="list" className="space-y-4">
            {rows.map((category) => {
              ...
              return (
                <li key={category.id} role="listitem" className="rounded-2xl border border-white/10 bg-[#0b132000]/80 p-6 shadow-sm hover:shadow-md transition-shadow">
                  <details
                    open
                    draggable
                    onDragStart={(event) => {
                  ...
                  >
                    ...
                    <div className="mt-5 space-y-5">
                      <div className="rounded-xl border border-white/10 bg-[#0b132000]/60 p-5">
                        <EntityForm
                          fields={schema.fields}
                      ...
                      <div className="rounded-xl border border-white/10 bg-[#0b132000]/50 p-5">
                        ...
                        <ul role="list" className="mt-4 space-y-2">
                          {toolRows.map((tool) => (
                            <li
                              key={tool.id}
                              role="listitem"
                              className="flex items-center justify-between rounded-xl border border-white/10 bg-[#0b132000]/60 px-4 py-3 hover:bg-white/5 transition-colors"
                              draggable
                              onDragStart={(event) => {
                            ...
                            >
                              <div className="flex items-center gap-3">
                                ...
                                <span className="rounded-full bg-[#06B6D4]/20 px-2 py-0.5 text-xs font-medium text-[#06B6D4]">{tool.proficiencyLevel}%</span>
                              </div>
                              <div className="flex items-center gap-2">
                                <button
                                  type="button"
                                ...
                                <button
                                  type="button"
                                  className="rounded-lg border border-[#06B6D4]/30 bg-[#06B6D4]/10 px-3 py-1 text-xs font-medium text-[#06B6D4] hover:bg-[#06B6D4]/20 transition-colors"
