...
export function DashboardHomePage() {
  ...
  const statCards = [
    { 
      ...
      bgGradient: 'from-[#06B6D4]/10 to-[#0891B2]/10',
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <NavLink 
          to="/"
          target="_blank"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-[#06B6D4] to-[#0891B2] text-white font-medium hover:shadow-lg hover:shadow-[#06B6D4]/30 transition-all"
        >
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {/* Published */}
        <div className="rounded-2xl bg-[#0b132000]/50 border border-white/10 p-6 shadow-sm hover:shadow-md transition-shadow">
        ...
        {/* Quick Actions */}
        <div className="rounded-2xl bg-gradient-to-br from-[#0b132000] to-[#0b132000]/80 p-6 text-white border border-white/10">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {/* Recent Activity */}
        <div className="rounded-2xl bg-[#0b132000]/50 border border-white/10 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            {recentActivity.map((activity, index) => (
              ...
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#06B6D4]/20 to-[#0891B2]/20">
