    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[#06B6D4] to-[#0891B2] text-white font-semibold rounded-xl shadow-lg shadow-[#06B6D4]/30 hover:shadow-xl hover:shadow-[#06B6D4]/40 hover:-translate-y-0.5 transition-all duration-300"
        >
      ...
      <div
        ...
        className={`relative rounded-2xl border-2 border-dashed transition-all duration-300 ${
          isDragging
            ...
            : 'border-white/20 bg-[#0b132000]/60 hover:border-white/30'
        }`}
      >
        <div className="flex flex-col items-center justify-center py-12 px-4">
          <div className={`flex h-16 w-16 items-center justify-center rounded-2xl mb-4 transition-all ${
            isDragging ? 'bg-[#06B6D4]/20 scale-110' : 'bg-[#0b132000]/80 border border-white/10'
          }`}>
            <Upload className={`w-8 h-8 transition-colors ${isDragging ? 'text-[#06B6D4]' : 'text-white/60'}`} />
          </div>
        ...
        {isUploading && (
          <div className="absolute inset-0 bg-[#0b132000]/80 backdrop-blur-sm rounded-2xl flex items-center justify-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-[#0b132000]/60 border border-white/10 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-[#06B6D4] focus:border-transparent transition-all"
          />
        </div>
        <div className="flex items-center gap-2">
          <select
            ...
            className="px-3 py-2 rounded-xl bg-[#0b132000]/60 border border-white/10 text-white focus:outline-none focus:ring-2 focus:ring-[#06B6D4] transition-all"
          >
          ...
          <div className="flex items-center gap-2 p-1 rounded-xl bg-[#0b132000]/60 border border-white/10">
            <button
              onClick={() => setViewMode('grid')}
              className={`p-2 rounded-lg transition-all ${
                viewMode === 'grid' ? 'bg-[#06B6D4]/20 text-[#06B6D4]' : 'text-white/60 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-all ${
                viewMode === 'list' ? 'bg-[#06B6D4]/20 text-[#06B6D4]' : 'text-white/60 hover:text-white'
              }`}
            >
      ...
      {/* Loading State */}
      {loading ? (
        <div className="rounded-2xl border border-white/10 bg-[#0b132000]/80 p-12 text-center">
        ...
        <div className="rounded-2xl border border-white/10 bg-[#0b132000]/80 p-12 text-center">
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-[#0b132000]/80 border border-white/10 mx-auto mb-4">
          ...
          {!searchQuery && (
            <button
              onClick={() => fileInputRef.current?.click()}
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#06B6D4]/20 text-[#06B6D4] font-medium rounded-lg hover:bg-[#06B6D4]/30 transition-colors"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {filteredMedia.map((file) => (
            <div
              key={file.id}
              className="group relative rounded-xl overflow-hidden bg-[#0b132000]/80 border border-white/10 hover:border-[#06B6D4]/50 transition-all duration-300 cursor-pointer"
            ...
            >
              <div className="aspect-square">
                {file.type === 'image' && file.previewUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center bg-[#0b132000]">
              ...
              <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                  ...
                  className="p-1.5 rounded-lg bg-black/60 text-white hover:bg-[#06B6D4] transition-colors"
                >
        ...
        <div className="rounded-2xl border border-white/10 bg-[#0b132000]/80 overflow-hidden">
              ...
              {filteredMedia.map((file) => (
                <tr key={file.id} className="hover:bg-white/5 transition-colors">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg overflow-hidden bg-[#0b132000] flex-shrink-0">
                        {file.type === 'image' && file.previewUrl ? (
                          <img src={file.previewUrl} alt={file.name} className="w-full h-full object-cover" />
                        ) : (
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg text-white/60 hover:text-[#06B6D4] hover:bg-[#06B6D4]/10 transition-all"
                      >
      ...
      {selectedFile && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setSelectedFile(null)}>
          ...
          <div className="relative z-10 w-full max-w-3xl bg-[#0b132000] rounded-2xl border border-white/10 overflow-hidden animate-scale-in" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-4">
              {selectedFile.type === 'image' && selectedFile.previewUrl ? (
                ...
                <div className="h-60 flex items-center justify-center bg-[#0b132000]/50 rounded-lg">
            ...
            <div className="flex items-center justify-between p-4 border-t border-white/10">
              <div className="flex-1 mr-4">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-[#0b132000]/60 border border-white/10 text-white/80 text-sm"
                />
              </div>
      ...
      {/* Info Note */}
      <div className="flex items-start gap-3 p-4 rounded-xl bg-[#06B6D4]/10 border border-[#06B6D4]/20">
