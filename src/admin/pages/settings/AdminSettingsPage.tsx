    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          onClick={handleSave}
          disabled={isSaving}
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[#06B6D4] to-[#0891B2] text-white font-semibold rounded-xl shadow-lg shadow-[#06B6D4]/30 hover:shadow-xl hover:shadow-[#06B6D4]/40 hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isSaving ? (
            <>
      ...
      <div className="grid lg:grid-cols-[240px_1fr] gap-6">
        {/* Sidebar */}
        <div className="rounded-2xl border border-white/10 bg-[#0b132000]/80 p-3 h-fit">
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 ${
                    activeSection === section.id
                      ? 'bg-gradient-to-r from-[#06B6D4]/20 to-[#0891B2]/20 text-white border border-[#06B6D4]/30'
                      : 'text-white/60 hover:text-white hover:bg-white/5'
                  }`}
                >
                  {section.icon && <section.icon className={`w-5 h-5 ${activeSection === section.id ? 'text-[#06B6D4]' : ''}`} />}
                  {section.label}
                </button>
              );
            })}
        ...
        {/* Content */}
        <div className="rounded-2xl border border-white/10 bg-[#0b132000]/80 p-6">
          {/* General Settings */}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-[#0b132000]/60 border border-white/10 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-[#06B6D4] transition-all"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 rounded-xl bg-[#0b132000]/60 border border-white/10 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-[#06B6D4] transition-all resize-none"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 rounded-xl bg-[#0b132000]/60 border border-white/10 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-[#06B6D4] transition-all"
                    />
                  </div>
                </div>
              </div>
          ...
          {activeSection === 'appearance' && (
            <div className="space-y-6">
              <div className="flex items-center gap-3 pb-4 border-b border-white/10">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#06B6D4]/20">
                  <Palette className="w-5 h-5 text-[#06B6D4]" />
                </div>
                <div>
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl border transition-all ${
                        settings.theme === 'dark'
                          ? 'bg-[#06B6D4]/20 border-[#06B6D4]/50 text-white'
                          : 'bg-[#0b132000]/60 border-white/10 text-white/60 hover:border-white/20'
                      }`}
                    >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <input
                      ...
                      value={settings.primaryColor}
                      onChange={(e) => setSettings({ ...settings, primaryColor: e.target.value })}
                      className="flex-1 px-4 py-3 rounded-xl bg-[#0b132000]/60 border border-white/10 text-white focus:outline-none focus:ring-2 focus:ring-[#06B6D4] transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  {[
                    ...
                    <label key={feature.key} className="flex items-center justify-between p-4 rounded-xl bg-[#0b132000]/60 border border-white/10 cursor-pointer hover:border-white/20 transition-all">
                      ...
                      <div className="relative">
                        ...
                        />
                        <div className="w-11 h-6 bg-white/10 rounded-full peer peer-checked:bg-[#06B6D4] transition-colors" />
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <label key={item.key} className="flex items-center justify-between p-4 rounded-xl bg-[#0b132000]/60 border border-white/10 cursor-pointer hover:border-white/20 transition-all">
                    <div>
          ...
          {activeSection === 'security' && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <label className="flex items-center justify-between p-4 rounded-xl bg-[#0b132000]/60 border border-white/10 cursor-pointer hover:border-white/20 transition-all">
                  <div>
                ...
                <div className="p-4 rounded-xl bg-[#0b132000]/60 border border-white/10">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      className="w-full px-4 py-3 rounded-xl bg-[#0b132000]/40 border border-white/10 text-white/40 placeholder-white/30 cursor-not-allowed"
                    />
                  </div>
                  <div>
