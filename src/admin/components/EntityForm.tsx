    ...
    >
      <div className={mediaFields.length > 0 ? 'grid gap-6 lg:grid-cols-[2fr_1fr]' : ''}>
              ...
              <label className="block text-sm font-medium text-[#C9D1D9]">
                ...
                {field.type === 'image' ? (
                  <div className="mt-2 space-y-2">
                    ...
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="text-xs text-white/40 hover:text-[#06B6D4] transition-colors flex items-center gap-1"
                      >
                    ...
                    {urlInputMode[field.name] ? (
                      /* URL Input Mode */
                      <input
                        className="w-full rounded-xl border border-white/10 bg-[#0b132000]/50 px-4 py-3 text-sm text-[#C9D1D9] focus:outline-none focus:ring-2 focus:ring-[#06B6D4]/20 focus:border-[#06B6D4] transition-all placeholder:text-white/30"
                        type="url"
                      ...
                      <div
                        className={`relative rounded-xl border-2 border-dashed transition-all ${
                          dragOver === field.name 
                            ...
                            : 'border-white/20 hover:border-[#06B6D4]/50'
                        }`}
                      ...
                      >
                        ...
                        <div className="flex flex-col items-center justify-center p-6 text-center">
                          {getNested(values, field.name) ? (
                            ...
                            <>
                              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#06B6D4]/20 mb-3">
                                <Upload className="w-5 h-5 text-[#06B6D4]" />
                              </div>
                              <p className="text-sm text-[#C9D1D9]">
                                <span className="text-[#06B6D4] font-medium">Click to upload</span> or drag and drop
                              </p>
                  ...
                  <div className="mt-2 space-y-2">
                    ...
                    {urlInputMode[field.name] ? (
                      ...
                      >
                        ...
                        <div className="flex flex-col items-center justify-center p-6 text-center">
                          {getNested(values, field.name) ? (
                            <div className="flex items-center gap-3 p-3 rounded-xl bg-[#0b132000]/60 border border-white/10">
                  ...
                  <div className="relative mt-2">
                    <select
                      className="w-full appearance-none rounded-xl border border-white/10 bg-[#0b132000]/50 px-4 py-3 pr-10 text-sm text-[#C9D1D9] focus:outline-none focus:ring-2 focus:ring-[#06B6D4]/20 focus:border-[#06B6D4] transition-all cursor-pointer"
                      value={String(getNested(values, field.name) ?? '')}
                      onChange={(event) => handleChange(field.name, event.target.value)}
                    >
                      <option value="" className="bg-[#0b132000]">Select {field.label}...</option>
                      {field.options?.map((option) => (
                        <option key={option} value={option} className="bg-[#0b132000]">
                          {option}
                        </option>
                      ))}
                    </select>
                  ...
                  <textarea
                    className="mt-2 w-full rounded-xl border border-white/10 bg-[#0b132000]/50 px-4 py-3 text-sm text-[#C9D1D9] focus:outline-none focus:ring-2 focus:ring-[#06B6D4]/20 focus:border-[#06B6D4] transition-all min-h-[120px] resize-y placeholder:text-white/30"
                  ...
                  <div className="mt-2 flex items-center">
                    <input
                      className="h-5 w-5 rounded border-white/10 text-[#06B6D4] focus:ring-[#06B6D4] transition-colors"
                      type="checkbox"
                  ...
                  <input
                    className="mt-2 w-full rounded-xl border border-white/10 bg-[#0b132000]/50 px-4 py-3 text-sm text-[#C9D1D9] focus:outline-none focus:ring-2 focus:ring-[#06B6D4]/20 focus:border-[#06B6D4] transition-all"
                    type="text"
                  ...
                  <div className="mt-2 space-y-3">
                    {(() => {
                      ...
                      return (
                        <div key={`${field.name}-${index}`} className="flex flex-col gap-3 rounded-xl border border-white/10 bg-[#0b132000]/60 p-4">
                          ...
                          <div className="flex flex-col gap-2 md:flex-row md:items-center">
                            <input
                              className="flex-1 rounded-xl border border-white/10 bg-[#0b132000]/50 px-4 py-2.5 text-sm text-[#C9D1D9] focus:outline-none focus:ring-2 focus:ring-[#06B6D4]/20 focus:border-[#06B6D4] transition-all"
                              placeholder="https://"
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            <button
                              type="button"
                              className="inline-flex items-center gap-1.5 rounded-xl border border-white/10 bg-[#0b132000]/50 px-4 py-2.5 text-sm font-medium text-[#C9D1D9] hover:bg-white/5 transition-colors"
                              onClick={() => {
                                const current = Array.isArray(getNested(values, field.name))
                                  ? ([...(getNested(values, field.name) as SocialLinkItem[])] as SocialLinkItem[])
                                  : [];
                            ...
                            {hasAnyLinks && (
                              <button
                                type="submit"
                                className="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-[#06B6D4] to-[#0891B2] px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-[#06B6D4]/20 hover:shadow-lg hover:shadow-[#06B6D4]/30 disabled:cursor-not-allowed disabled:opacity-50 transition-all"
                  ...
                  <input
                    className={`mt-2 w-full rounded-xl border border-white/10 bg-[#0b132000]/50 px-4 py-3 text-sm text-[#C9D1D9] focus:outline-none focus:ring-2 focus:ring-[#06B6D4]/20 focus:border-[#06B6D4] transition-all placeholder:text-white/30 ${
        ...
        {mediaFields.length > 0 && (
          <aside className="rounded-2xl border border-white/10 bg-gradient-to-br from-[#0b132000]/60 to-[#06B6D4]/10 p-5">
                ...
                return (
                  <div key={field.name} className="space-y-2">
                    ...
                    {value ? (
                      ...
                      <div className="w-full aspect-square rounded-xl border border-dashed border-white/20 bg-[#0b132000]/40 flex flex-col items-center justify-center">
      ...
      {!hasSocialLinksField && (
        <div className="flex items-center gap-3 pt-2">
          <button 
            type="submit"
            disabled={isSaving}
            className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#06B6D4] to-[#0891B2] px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-[#06B6D4]/20 hover:shadow-lg hover:shadow-[#06B6D4]/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSaving ? (
              <>
