...
export function PublicationsPage() {
  ...
  useDocumentHead({
    title: 'Publications & Research — Jessica Latoria Davis',
    description: 'Technical publications, articles, and professional work by Jessica Latoria Davis in full stack development, cloud architecture, DevOps, and software engineering.',
    path: '/publications',
  });
    ...
    <div className="space-y-16 pb-16">
      ...
      <section className="relative pt-8 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#0b132000]/60 border border-white/10 mb-6 animate-slide-in-left hover:scale-105 transition-transform">
          ...
          <span className="text-sm font-medium text-[#06B6D4]">Research & Papers</span>
        </div>
        ...
        <section className="space-y-6">
          {publications.map((pub, index) => (
            <article key={pub.id} className="group relative animate-fade-in" style={{ animationDelay: `${index * 100}ms` }}>
              ...
              <div className="relative bg-[#0b132000]/80 backdrop-blur-sm rounded-xl p-6 shadow-lg shadow-[#06B6D4]/[0.05] border border-white/[0.06] hover:shadow-xl hover:shadow-[#06B6D4]/[0.12] hover:-translate-y-1 hover:border-white/[0.12] transition-all duration-600 ease-out card-animated">
                <div className="flex flex-col md:flex-row md:items-start gap-6">
                  {/* Publication Number */}
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#06B6D4]/10 border border-[#06B6D4]/15 flex-shrink-0 group-hover:bg-[#06B6D4]/15 group-hover:border-[#06B6D4]/25 transition-all duration-500 ease-out">
                    <span className="text-xl font-bold text-[#06B6D4]">{String(index + 1).padStart(2, '0')}</span>
                  </div>
                  
                  <div className="flex-1 space-y-3">
                    {/* Title */}
                    <h2 className="text-xl font-bold text-white group-hover:text-[#06B6D4] transition-colors">
                      {pub.title}
                    </h2>
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm">
                      {pub.publisher && (
                        <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-[#06B6D4]/20 text-[#06B6D4] font-medium group-hover:bg-[#06B6D4]/30 transition-colors">
                    ...
                    <div className="flex items-center gap-3 pt-3">
                      {pub.pdfUrl && (
                        <a 
                          ...
                          target="_blank" 
                          rel="noreferrer"
                          className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#06B6D4]/20 text-[#06B6D4] text-sm font-medium hover:bg-[#06B6D4]/30 hover:-translate-y-0.5 hover:shadow-md transition-all duration-300 group/link"
                        >
                      ...
                      {pub.externalUrl && (
                        <a 
                          ...
                          target="_blank" 
                          rel="noreferrer"
                          className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#0b132000]/50 text-[#C9D1D9] text-sm font-medium hover:bg-white/10 hover:-translate-y-0.5 hover:shadow-md transition-all duration-300 group/link"
                        >
